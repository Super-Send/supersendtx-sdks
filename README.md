...
Official thin HTTP clients for the [SuperSend TX](https://supersendtx.com) transactional email API.
...
SDKs are developed in the private SuperSend TX application monorepo and mirrored here on release.
Do not open PRs for API changes in this repository — use [Super-Send/superTX-app](https://github.com/Super-Send/superTX-app) (private, team access only).
